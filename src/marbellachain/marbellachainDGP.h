#ifndef MARBELLACHAINDGP_H
#define MARBELLACHAINDGP_H
...
class MarbellaChainDGP {
    
public:

    MarbellaChainDGP(MarbellaChainState* _state, bool _dgpevm = true) : dgpevm(_dgpevm), state(_state) { initDataEIP158(); }
...
private:
    ...
    const MarbellaChainState* state;
