...
{
    const char* pszTimestamp = "Financial Times - HSBC banks on blockchain to finesse forex trades";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1547542810, 119691, 0x1f00ffff, 1, 1 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000cdfed9bb97a00360682a3efd2c5558040ed7bfeadfa1cb6b142df5da4842"));
        assert(genesis.hashMerkleRoot == uint256S("0xd93508d5eaa13f1b48f69bce8d596f18830dd2b2bb3e3ca51300dd02625e114a"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1520123895, 3652034072, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
