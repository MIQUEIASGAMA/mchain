#ifndef MARBELLACHAINVERSIONCHECKER_H
#define MARBELLACHAINVERSIONCHECKER_H

#include <QObject>

#define MARBELLACHAIN_RELEASES "https://github.com/marbellachain/marbellachain/releases"
...
class MarbellaChainVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit MarbellaChainVersionChecker(QObject *parent = 0);
    ~MarbellaChainVersionChecker();
...
#endif // MARBELLACHAINVERSIONCHECKER_H
