#ifndef MCHAINVERSIONCHECKER_H
#define MCHAINVERSIONCHECKER_H

#include <QObject>

#define MCHAIN_RELEASES "https://github.com/mchainnetwork/mchain/releases"
...
class MchainVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit MchainVersionChecker(QObject *parent = 0);
    ~MchainVersionChecker();
