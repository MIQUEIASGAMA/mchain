...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("MarbellaCoins");
    case mBTC: return QString("Milli-MarbellaCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-MarbellaCoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
QString BitcoinUnits::formatToken(int decimal_units, const int256_t& nIn, bool fPlus, SeparatorStyle separators)
{
    ...
    {
        return QString(quotient_str + QString(".") + remainder_str).remove(QRegExp("\\.?0*$"));
    }
    return quotient_str.remove(QRegExp("\\.?0*$"));
}
