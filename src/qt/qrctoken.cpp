...
public:
               ...
               const QModelIndex &index) const
    {
        ...
        if(selected)
        {
            painter->fillRect(mainRect,QColor("#0099bf"));
            QColor foreground("#fff");
        ...
        QRect tokenSymbolRect(mainRect.left() + MARGIN, mainRect.top() + MARGIN, SYMBOL_WIDTH + MARGIN, mainRect.height() / 2 - MARGIN);
