    ...
    platformStyle(_platformStyle)
{
    ...
    SetObjectStyleSheet(ui->addButton, StyleSheetNames::ButtonWhite);
    SetObjectStyleSheet(ui->sendButton, StyleSheetNames::ButtonBlue);
    SetObjectStyleSheet(ui->pushButtonCoinControl, StyleSheetNames::ButtonWhite);
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid MarbellaChain address"));
        }
        else // Valid address
        {
