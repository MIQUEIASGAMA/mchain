...
void ReceiveRequestDialog::update()
{
    ...
    html += "<font color='#333'>" + tr("PAYMENT INFORMATION")+"</font><br><br>";
    html += tr("URI")+": ";
    html += "<a href=\""+uri+"\">" + GUIUtil::HtmlEscape(uri) + "</a><br>";
    html += tr("Address")+": <font color='#333'>" + GUIUtil::HtmlEscape(info.address) + "</font><br>";
    if(info.amount)
        html += tr("Amount")+": <font color='#333'>" + BitcoinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "</font><br>";
    if(!info.label.isEmpty())
        html += tr("Label")+": <font color='#333'>" + GUIUtil::HtmlEscape(info.label) + "</font><br>";
    if(!info.message.isEmpty())
        html += tr("Message")+": <font color='#333'>" + GUIUtil::HtmlEscape(info.message) + "</font><br>";
