...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see mchain-dgp.py
"""
class MchainDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the mchaind to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    MchainDGPActivation().main()
